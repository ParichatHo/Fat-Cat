    ...
    <div class="max-w-4xl mx-auto p-6">
        <div class="space-y-6">
            ...
            <div v-else-if="record" class="space-y-6">
                ...
                <UPageCard title="Pet Information" description="Details about the pet for this medical record.">
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="w-full md:w-1/2 flex justify-center items-center">
                            ...
                            <div v-else
                                class="w-full h-64 flex items-center justify-center bg-gray-100 rounded-md text-gray-500">
                                No image available
                            </div>
                        </div>
                            ...
                            <UForm :state="record" class="space-y-4">
                                ...
                                <div class="flex flex-col md:flex-row gap-4">
                                    <UFormField label="Pet Name" name="pet_name" class="w-full md:w-1/2">
                                        <UInput :model-value="record.pet?.pet_name || 'Unknown Pet'" readonly
                                            class="w-full" />
                                    </UFormField>

                                    <UFormField label="Breed" name="breed_name" class="w-full md:w-1/2">
                                        <UInput :model-value="record.pet?.breed_name || 'Not specified'" readonly
                                            class="w-full" />
                                    </UFormField>
                                </div>
                                ...
                                <div class="flex flex-col md:flex-row gap-4">
                                    ...
                                    <UFormField label="Gender" name="gender" class="w-full md:w-1/2">
                                        <UInput :model-value="record.pet?.gender || 'Not specified'" readonly
                                            class="w-full" />
                                    </UFormField>
                                </div>
                                ...
                                <div class="flex flex-col md:flex-row gap-4">
                                    <UFormField label="Weight" name="weight" class="w-full md:w-1/2">
                                        <UInput
                                            :model-value="record.pet?.weight ? `${record.pet.weight} kg` : 'Not specified'"
                                            readonly class="w-full" />
                                    </UFormField>

                                    <UFormField label="Birth Date" name="birth_date" class="w-full md:w-1/2">
                                        <UInput
                                            :model-value="record.pet?.birth_date ? formatDate(record.pet.birth_date) : 'Not specified'"
                                            readonly class="w-full" />
                                    </UFormField>
                                </div>
                            </UForm>
                ...
                <!-- Owner Information -->
                <UPageCard v-if="record.pet?.owner" title="Owner Information"
                    ...
                    <UForm :state="record" class="space-y-4">
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            ...
                            <UFormField label="Phone" name="owner_phone" class="w-full md:w-1/2">
                                <UInput :model-value="record.pet.owner.phone || 'Not provided'" readonly
                                    class="w-full" />
                            </UFormField>
                        </div>
                        ...
                        <UFormField label="Address" name="owner_address">
                            <UTextarea :model-value="record.pet.owner.address || 'Not provided'" readonly
                                class="w-full" />
                        </UFormField>
                    </UForm>
                </UPageCard>
                    ...
                    <UForm :state="record" class="space-y-4">
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            <UFormField label="First Name" name="vet_first_name" class="w-full md:w-1/2">
                                <UInput :model-value="record.vet?.user?.first_name || 'Unknown'" readonly
                                    class="w-full" />
                            </UFormField>

                            <UFormField label="Last Name" name="vet_last_name" class="w-full md:w-1/2">
                                <UInput :model-value="record.vet?.user?.last_name || 'Unknown'" readonly
                                    class="w-full" />
                            </UFormField>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            <UFormField label="License Number" name="license_number" class="w-full md:w-1/2">
                                <UInput :model-value="record.vet?.license_number || 'Not provided'" readonly
                                    class="w-full" />
                            </UFormField>

                            <UFormField label="Experience" name="experience" class="w-full md:w-1/2">
                                <UInput
                                    :model-value="record.vet?.experience ? `${record.vet.experience} years` : 'Not specified'"
                                    readonly class="w-full" />
                            </UFormField>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            <UFormField label="Education" name="education" class="w-full md:w-1/2">
                                <UInput :model-value="record.vet?.education || 'Not provided'" readonly
                                    class="w-full" />
                            </UFormField>

                            <UFormField label="Email" name="vet_email" class="w-full md:w-1/2">
                                <UInput :model-value="record.vet?.user?.email || 'Not provided'" readonly
                                    class="w-full" />
                            </UFormField>
                        </div>
                ...
                <UPageCard title="Medical Details" description="Detailed medical information and treatment records.">
                    <UForm :state="record" class="space-y-4">
                        ...
                        <UFormField label="Symptoms" name="symptoms">
                            <UTextarea :model-value="record.symptoms || 'No symptoms recorded'" readonly
                                class="w-full" />
                        </UFormField>

                        <!-- Diagnosis -->
                        <UFormField label="Diagnosis" name="diagnosis">
                            <UTextarea :model-value="record.diagnosis || 'No diagnosis recorded'" readonly
                                class="w-full" />
                        </UFormField>

                        <!-- Treatment -->
                        <UFormField label="Treatment" name="treatment">
                            <UTextarea :model-value="record.treatment || 'No treatment recorded'" readonly
                                class="w-full" />
                        </UFormField>

                        <!-- Medication -->
                        <UFormField label="Medication" name="medication">
                            <UTextarea :model-value="record.medication || 'No medication prescribed'" readonly
                                class="w-full" />
                        </UFormField>
                ...
                <!-- Record Timestamps -->
                <UPageCard title="Record Information"
                    ...
                    <UForm :state="record" class="space-y-4">
                        <div class="flex flex-col md:flex-row gap-4">
                            ...
                            <UFormField label="Updated At" name="updatedAt" class="w-full md:w-1/2">
                                <UInput
                                    :model-value="record.updatedAt ? formatDateTime(record.updatedAt) : 'Never updated'"
                                    readonly class="w-full" />
                            </UFormField>
                        </div>
                    </UForm>
            ...
            <div v-else class="text-center py-10">
                ...
                <UButton label="Back to Records" color="primary" variant="outline"
