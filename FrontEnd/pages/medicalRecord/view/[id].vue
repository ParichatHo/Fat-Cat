...
function editRecord() {
  router.push(`/medicalRecord/edit/${recordId}`)
}
...
<template>
  <div class="p-6 mx-auto" style="max-width: 900px;">
    <div class="space-y-6">
          ...
          <UForm :state="record" class="space-y-4">
            ...
            <div class="flex flex-col md:flex-row gap-4">
              ...
              <UFormField label="Experience" name="experience" class="w-full md:w-1/2">
                <UInput :model-value="record.vet?.experience ? `${record.vet.experience} years` : 'Not specified'" readonly class="w-full" />
              </UFormField>
            </div>
          ...
          <UForm :state="record" class="space-y-4">
            <div class="flex flex-col md:flex-row gap-4">
              ...
              <UFormField label="Updated At" name="updatedAt" class="w-full md:w-1/2">
                <UInput :model-value="record.updatedAt ? formatDateTime(record.updatedAt) : 'Never updated'" readonly class="w-full" />
              </UFormField>
            </div>
          </UForm>
        </UPageCard>
